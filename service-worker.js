...
const CACHE_VERSION = 'vforge-v7-1-0-focus-local-first-hotfix';

const ASSETS_TO_CACHE = [
  './index.html',
  './css/style.css?v=7.1.0',
  './js/firebase-config.js?v=7.1.0',
  './js/app.js?v=7.1.0',
  './js/projects.js?v=7.1.0',
  './js/workspace.js?v=7.1.0',
  './js/processor.js?v=7.1.0',
  './js/auth.js?v=7.1.0',
  './js/studio.js?v=7.1.0',
